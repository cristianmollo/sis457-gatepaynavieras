...
using System.Text;
using FinalGatePayNavieras.Controllers;
...
namespace FinalGatePayNavieras.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(FinalGatePayNavierasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string? returnUrl = null)
        {
            ...
            var usuario = _context.Usuarios
                .Where(x => x.Estado == 1 && x.NombreUsuario == model.usuario &&
                    x.Contrasena == Encrypt(model.clave)).FirstOrDefault();
            if (usuario != null)
            {
