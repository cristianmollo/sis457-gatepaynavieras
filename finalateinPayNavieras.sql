...
CREATE DATABASE FinalGatePayNavieras;
GO
USE [master]
GO
ALTER LOGIN [usrthalassa] WITH PASSWORD = N'123456', 
	DEFAULT_DATABASE=[FinalGatePayNavieras], 
	CHECK_EXPIRATION=OFF, 
	CHECK_POLICY=ON;
GO
USE [FinalGatePayNavieras]
GO
...
CREATE PROC paNavieraListar @parametro VARCHAR(100)
AS
BEGIN
    SELECT * 
    FROM Naviera
...
ALTER PROC paSolicitudPagoListar
...
CREATE PROC paGateInListar @parametro VARCHAR(100)
AS
BEGIN
